    ...
    <footer className="border-t border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950">
      <div className="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
        <div className="flex justify-center space-x-6 md:order-2">
          <a
            href="https://github.com/Beagle-AI-automation/promptperfect.git"
            target="_blank"
            rel="noreferrer"
        ...
        <div className="mt-8 md:order-1 md:mt-0">
          <div className="flex flex-col items-center gap-2 md:items-start">
            <p className="text-center text-xs leading-5 text-zinc-500 dark:text-zinc-400">
              &copy; {new Date().getFullYear()} PromptPerfect. Open Source under MIT License.
            </p>
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-zinc-400">Built by Beagle Builder Program</span>
            </div>
          </div>
        </div>
      </div>
